...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active"> Create Common Questions Page</li>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header text-center">
                    <h2 class="m-0">Create Common Questions</h2>
                </div>
                <div class="card-body">
                    <form action="{{route('common_questions.store')}}" method="post" enctype="multipart/form-data">
