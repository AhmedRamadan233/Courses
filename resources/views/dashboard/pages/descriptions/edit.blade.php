    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('description.update', ['description' => $editedDescription->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="question" name="question" value="{{ $editedDescription->question }}">
                            @error('question')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="answer" name="answer" value="{{ $editedDescription->answer }}">
                            @error('answer')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div> 
